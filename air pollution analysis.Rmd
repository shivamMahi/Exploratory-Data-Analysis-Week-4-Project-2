...
x1<-barplot(height=annual$Annual.Total/1000, names.arg=annual$year,
            ...
            main=expression('Total PM'[2.5]*' emissions at various years in kilotons'),col=annual$year)
...
x2<-barplot(height=baltimore$Annual.Total/1000, names.arg=baltimore$year,
            ...
            main=expression('Total PM'[2.5]*' emissions in Baltimore City-MD in kilotons'),col=baltimore$year)
...
##6) Compare emissions from motor vehicle sources in Baltimore City with emissions from motor vehicle sources in Los Angeles County, California (𝚏𝚒𝚙𝚜 == “𝟶𝟼𝟶𝟹𝟽”. Which city has seen greater changes over time in motorvehicle emissions?
